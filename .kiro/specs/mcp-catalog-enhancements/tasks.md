...
- [x] 2.2 mTLS 証明書とコンテナ起動フラグを具体化する
...
- [x] 4. 外部/E2B ゲートウェイ接続とヘルスチェックを実装する
