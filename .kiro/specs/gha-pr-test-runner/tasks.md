...
- [x] 1. ubuntu-slim ランナー上での共通セットアップを確立する
...
- [x] 2. バックエンド Pytest ジョブを PR トリガーで実行する
...
- [x] 3. フロントエンド Jest ジョブを PR トリガーで実行する
...
- [x] 4. Playwright E2E ジョブを slim 上で安定実行する
...
- [x] 6. 必須チェックとトリガー条件を統合し、品質ゲートを担保する
